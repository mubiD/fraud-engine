...
This is a **real-time transaction fraud detection engine** for Capitec Bank. It evaluates financial transactions against a chain of five rule-based fraud detectors, persists the results, and routes outcomes downstream. The service is built on Spring Boot 3.3 / Java 21.
